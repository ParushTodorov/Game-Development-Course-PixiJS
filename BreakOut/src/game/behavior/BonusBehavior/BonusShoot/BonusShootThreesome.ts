...
export class BonusShootThreesome extends BonusShootBaseBehavior {

    public timesToShoot: number = 3;
    protected static instance: BonusShootThreesome;
    protected shootTimer: number = 3;
    public bonusTimer: number = 9;
